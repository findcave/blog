    ...
    <div class="row">
        <div class="col">
            <h3 class="text-info">New Department</h3>
            <hr>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form name="registerform" action="<?php echo base_url(); ?>department/store" method="post" >
                <div class="form-group">
                    <label for="name">Name</label>
                    <input type="text" class="form-control" id="name" value="<?php echo set_value('name') ;?>" name="name"  >
                ...
                <a href="<?php echo base_url();?>department" class="btn btn-light">Cancel</a>
            </form>
        </div>
    </div>
